...
-- 例如 耐久用尽自动卸下, 不允许装备等, 数据填写在 `TUNING.MOD_MAGELLAN_REMAKE.REPAIR_COMMON` 中,本文件不需要做任何修改

local db = TUNING.MOD_MAGELLAN_REMAKE.REPAIR_COMMON
                ...
                if inst.components.finiteuses then
                    ...
                    function inst.components.finiteuses.onfinished(this,...)
                        if v.autounequip_whennodurability then
                            SUGAR_magellan_remake:unequipItem(this)
                        end
