...
function (self)
    local GetIngredients = self.GetIngredients
    self.GetIngredients = function(self, recname, ...)
        local recipe = AllRecipes[recname]
        if recipe and self.inst:HasTag("mgl") then
            local ingredients = {}
            ...
            return GetIngredients(self, recname, ...)
        end
    end
