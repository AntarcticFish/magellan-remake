-- 功能(无需修改): alt写的修改攻速模块
-- 修改 `TUNING.MOD_magellan_remake.ATK_SPEED_ALT` 的值,来改变攻速
...
AddComponentPostInit("playervision", function(self)
    ...
    doer:ListenForEvent("newstate", function(inst, data)
        ...
        if inst.magellan_remake_remove_sgtag_task then
            inst.magellan_remake_remove_sgtag_task:Cancel()
        ...
        if isAttackingSG(inst, statename) then
            ...
            local new_attackspeed = orange_attackspeed * TUNING.MOD_MAGELLAN_REMAKE.ATK_SPEED_ALT
            ...
            inst.magellan_remake_remove_sgtag_task = inst:DoTaskInTime(newperiod,
                function()
